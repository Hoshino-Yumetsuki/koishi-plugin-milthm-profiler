...
/**
 * 检查 Top20 是否全部满足 V3 条件 (对应 web checkTop20V3Condition)
 */
...
function buildHeader(
  ...
  children.push(
    container({
      ...
      children: [
        textNode(
          'Generated From: https://mkzi-nya.github.io/milthm-calculator-web/',
